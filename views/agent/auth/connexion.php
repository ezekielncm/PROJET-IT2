...
<div class="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-8">
    <div class="w-full max-w-xl bg-white shadow-lg rounded-2xl px-8 pt-10 pb-8">
        <h2 class="text-2xl font-bold text-blue-600 text-center mb-8">Connexion Agent</h2>

        <form method="POST" action="/home-agent" class="space-y-5">
            <div>
                <label for="username" class="block text-gray-700 font-medium text-sm">Nom d'utilisateur</label>
