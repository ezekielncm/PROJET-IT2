...
<div class="container mx-auto px-4 py-8">
    <h2 class="text-2xl font-bold mb-6">Acheter cette propriete</h2>
    ...
    <?php foreach ($proprietes as $propriete): ?>
        ...
        <?php  
$_SESSION['id_propriete']=$propriete['id'];
 
?>
    <?php endforeach; ?>

    <!-- Formulaire placé en bas du conteneur -->
    <form action="/Acheter-proprietes" method="POST"
        ...
        <button type="submit"
            ...
            Demander une validation d'achat
        </button>
    </form>
</div>
