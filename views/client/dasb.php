  ...
  <main class="flex-1 p-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <a href="/mes-proprietes" class="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition duration-200">
        ...
        <p class="text-3xl font-bold text-blue-600 mt-2"><?= isset($nbr_proprietes_louer)? htmlspecialchars($nbr_proprietes_louer ): 0 ?> | <?= isset($nombresAchat)? htmlspecialchars($nombresAchat ): 0 ?></p>
