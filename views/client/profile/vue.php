                    ...
                    <div class="bg-white shadow-lg rounded-2xl overflow-hidden w-full max-w-4xl">
                        <div class="flex flex-col md:flex-row">
                            ...
                            <div class="w-full md:w-2/3 p-6">
                                ...
                                <p class="text-gray-700 mb-4"><strong>Agent Affilie :</strong> <i> <?= htmlspecialchars($bails['nom_agent'] . ' ' . $bails['prenom_agent']) ?></i></p>

                                <!-- Bouton Modifier -->
                                <div class="mt-6 text-center md:text-left">
                                    <a href="/modifier-profil?id=<?= base64_encode($bails['id']) ?>"
