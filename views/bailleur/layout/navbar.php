    ...
    <div class="flex min-h-screen">
      <aside class="w-64 bg-blue-700 text-white p-6 space-y-6">
        ...
        <nav class="space-y-2">
          ...
          <a href="/voir-mes-demande-de-visite" class="block px-4 py-2 rounded hover:bg-blue-600">Demandes reçues</a>
          <a href="/bailleur/conversations" class="block px-4 py-2 rounded hover:bg-blue-600">mes conversations</a>
