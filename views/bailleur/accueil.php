...
<?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white p-6 rounded-xl shadow-md">
                   ...
                   <p class="text-3xl font-semibold text-blue-600"><?=  isset($nbreProprietes)?$nbreProprietes : 0 ?></p>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <p class="text-3xl font-semibold text-green-600"><?= isset($rdv_) ? $rdv_ : 0 ?></p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md action">
                ...
                <div class="space-x-4">
                    ...
                    <a href="/nouvelle-propiete?id=<?= $encodedId ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700"> Ajouter une propriete</a>

                    <a href="/voir-mes-demande-de-visite" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">Voir les demandes</a>
                    <a href="Mon-profil?id=<?= $encodedId?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700">Mon profil</a>
                    <a href="/ventes-locations" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700">Ventes - Locations</a>
                </div>
            </div>
        </main>
        </div>
